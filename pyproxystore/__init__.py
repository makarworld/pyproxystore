...
class ProxyStore:
    ...
    def get_category(self, nokey: bool = False) -> dict:
        """
        ...
        """
        params = {"nokey": nokey}
        return self.request("getcategory", params)

    def get_price(self, count: int, period: int, category: str, country: str) -> dict:
        """
        ...
        return self.request("getprice", params=params)

    def get_count(self, country: str = None, category: str = None) -> dict:
        """
        ...
        return self.request("getcount", params=params)

    def get_country(self, category: str) -> dict:
        """
        ...
        """
        params = {"category": category}
        return self.request("getcountry", params=params)
    ...
    def get_proxy(
        ...
        return self.request("getproxy", params=params)

    def set_ip_auth(self, ids: str, ips: str) -> dict:
        """
        ...
        return self.request("setipauth", params=params)

    def set_type(self, ids: str, proxy_type: str) -> dict:
        """
        ...
        return self.request("settype", params=params)

    def set_descr(self, ids: str, comment: str, old_comment: str) -> dict:
        """
        ...
        return self.request("setdescr", params=params)
    ...
    def buy(
        ...
        return self.request("buy", params=params)
    ...
    def prolong(
        ...
        return self.request("prolong", params=params)
    ...
    def autoprolong(
        ...
        return self.request("autoprolong", params=params)

    def delete(self, ids: str) -> dict:
        """
    ...
    def check(self, ids: str) -> dict:
        ...
        """
        params = {"ids": ids}
        return self.request("check", params=params)
